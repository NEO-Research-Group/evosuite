...
public class JobHandler extends Thread {
    ...
    private List<String> getCommandString(JobDefinition job) {
        ...
        File seedIn = StorageManager.getSeedInFolder();
    ...
    private List<String> getOutputVariables() {
        ...
        commands.add("-Ddi_profile=" + Properties.DI_PROFILE);
        commands.add("-DdiProfileSpringA=" + Arrays.toString(Properties.DI_PROFILE_SPRING_ANNOTATIONS).
                replace("[", "").
                replace("]", "").
                replaceAll(", ", ":"));
